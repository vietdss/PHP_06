...
// Determine the total number of products that match the search query
$sql_count_sanpham = "SELECT COUNT(*) AS total FROM tbl_sanpham, tbl_danhmuc WHERE tbl_sanpham.id_danhmuc = tbl_danhmuc.id_danhmuc AND tbl_sanpham.tensanpham LIKE '%$query%'";
...
if ($category == "All") {
	$sql_show_sanpham = "SELECT * FROM tbl_sanpham, tbl_danhmuc WHERE tbl_sanpham.id_danhmuc = tbl_danhmuc.id_danhmuc AND tbl_sanpham.tensanpham LIKE '%$query%' ORDER BY tbl_sanpham.id_sanpham DESC LIMIT $start_index, $products_per_page";
} else {
	$sql_show_sanpham = "SELECT * FROM tbl_sanpham, tbl_danhmuc WHERE tbl_sanpham.id_danhmuc = tbl_danhmuc.id_danhmuc AND tbl_sanpham.tensanpham LIKE '%$query%' AND tbl_danhmuc.tendanhmuc = '$category' ORDER BY tbl_sanpham.id_sanpham DESC LIMIT $start_index, $products_per_page";
}
// Retrieve products for the current page based on the search query
					...
					<div class="sidebar">
						<div class="sidebar_section">
							...
							<ul class="sidebar_categories">
								<li><a href="product_search.php?query=<?php echo $query ?>">All</a></li>
								<?php foreach ($query_danhmuc as $row) { ?>
									<li><a href="product_search.php?category=<?php echo $row['tendanhmuc'] ?>&query=<?php echo $query ?>"><?php echo $row['tendanhmuc'] ?></a></li>
								<?php } ?>
							</ul>
						</div>
